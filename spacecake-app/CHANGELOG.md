...
- 5ce8d3d: Fixing parcel/watcher & node-pty compatibility issue.

## 0.1.0-alpha.22

### Patch Changes

- 8ac4ad0: Adding integrated terminal (Ghostty).
...
- 1abce81: Refactoring file save logic into state machine.
