...
const createTestElectronAPI = (overrides: Partial<ElectronAPI> = {}): ElectronAPI => ({
  ...
  setTerminalTabState: async () => {},
  getTerminalTabState: async () => null,
  onTerminalOutput: () => () => {},
  onIdeDisconnected: () => () => {},
  openExternal: async () => {},
  db: {
  ...
  git: {
    ...
    getLineDiff: async () => right([]),
    clone: async () => right(""),
    init: async () => right(""),
    stashPush: async () => right(undefined),
    stashPop: async () => right(undefined),
    stashList: async () => right([]),
    stashDrop: async () => right(undefined),
    getConflictContent: async () => right({ ours: "", theirs: "", base: "" }),
    resolveConflict: async () => right(undefined),
    getRemoteUrl: async () => right(null),
  },
  ...overrides,
})
