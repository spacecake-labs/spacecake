...
export const ClaudeTaskIdSchema = Schema.String.pipe(Schema.brand("ClaudeTaskId"))
export type ClaudeTaskId = typeof ClaudeTaskIdSchema.Type

export const ClaudeTaskListIdSchema = Schema.String.pipe(Schema.brand("ClaudeTaskListId"))
...
export const ClaudeTaskStatusSchema = Schema.Literal("pending", "in_progress", "completed")
