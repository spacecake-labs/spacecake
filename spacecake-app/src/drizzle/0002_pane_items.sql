...
ALTER TABLE "editor" DROP COLUMN "index";--> statement-breakpoint
ALTER TABLE "editor" DROP COLUMN "is_active";--> statement-breakpoint
ALTER TABLE "editor" DROP COLUMN "last_accessed_at";--> statement-breakpoint
ALTER TABLE "pane" DROP COLUMN "is_active";
