...
export const editorTheme: EditorThemeClasses = {
  ...
  list: {
    ...
    checklist: "relative",
    listitemChecked:
      'relative mx-2 px-6 list-none outline-none text-muted-foreground before:content-[""] before:size-4 before:shrink-0 before:rounded-[4px] before:border before:border-emerald-500/30 before:bg-emerald-500/[0.06] before:top-0.5 before:left-0 before:cursor-pointer before:block before:absolute before:shadow-xs before:flex before:items-center before:justify-center after:content-["✓"] after:absolute after:top-0.5 after:left-0 after:w-4 after:h-4 after:text-emerald-400 after:text-xs after:font-bold after:flex after:items-center after:justify-center after:pointer-events-none',
    listitemUnchecked:
