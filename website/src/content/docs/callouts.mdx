---
title: callouts
description: Obsidian-style callouts for notes, tips, warnings, and other admonitions.
---

callouts are styled blocks that highlight important content — notes, tips, warnings, and other admonitions. spacecake uses the same syntax as [obsidian](https://help.obsidian.md/callouts), so files move cleanly between the two.
...
fold state is session-only — it resets when you reopen the file, matching obsidian's behaviour.
