...
`spacecake` is currently available for macOS. Download the latest release from the [homepage](/) or [GitHub](https://github.com/spacecake-labs/spacecake-releases/releases).
...
**need help?**
found a bug or have a question? open an issue on [GitHub](https://github.com/spacecake-labs/spacecake-releases/issues).
