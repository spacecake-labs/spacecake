...
- learn about [workspaces, the sidebar, and panels](/editor-basics)
- explore [markdown features](/writing-markdown) like slash commands, code blocks, and mermaid diagrams
- use the [git panel](/git) for staging, committing, and branch management
- set up the [claude code integration](/claude-code-integration) for AI-assisted editing
- see all [keyboard shortcuts](/keyboard-shortcuts)
