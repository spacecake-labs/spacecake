...
spacecake includes an integrated terminal docked to the right of the editor by default. toggle it with `` ctrl+` ``, or click and drag the edge to resize. to change the dock position, right-click the terminal button in the status bar.
