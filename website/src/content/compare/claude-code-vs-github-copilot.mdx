...
coverImage:
  src: "/images/articles/claude-code-vs-gh-copilot.webp"
  alt: "Claude Code versus GitHub Copilot AI coding assistant feature comparison"
...
<ComparisonTable
  ...
  features={[
    {
      name: "Approach",
      values: ["Terminal agent + IDE extensions", "IDE-integrated assistant + coding agent"],
    },
    ...
    {
      name: "Code reasoning",
      values: ["Excellent (Opus 4.6)", "Good (model dependent)"],
      highlight: 0,
    },
    {
    ...
    },
    {
      name: "IDE support",
      values: [
        "VS Code, JetBrains, desktop, web, terminal",
    ...
    },
    {
      ...
      values: ["Agent teams (experimental)", "Coding agent (GitHub Actions)"],
    },
